	...
	<div class="top-header dont-print">
		<div class="container">
			<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
				...
				<li class="btn btn-link"><a href="admin/index.php">Admin Login</a></li>
			</ul>
			<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s">
...
<div class="header dont-print">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a class="" href="index.php">Santa fe Port Tourist Biological fee Collection And Staycation <span class="text-white badge bg-dark">Management System</span></a>
		</div>
