...
if (isset($_POST['signin'])) {
    ...
    $status = 2;
    $captchaResponse = $_POST['g-recaptcha-response']; // Get CAPTCHA response
    ...
    if (intval($responseKeys["success"]) !== 1) {
        ...
        // CAPTCHA was successful, proceed with user authentication
...
<script type="text/javascript">
    var onloadCallback = function() {
        grecaptcha.render('html_element', {
            'sitekey' : '6LeBZG0qAAAAAHpE8Nr7ZxDcFQw3dVdkeJ4p3stl' // Your reCAPTCHA Site Key
        });
    };
</script>
