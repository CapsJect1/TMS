			...
			<div class="container">
				...
				<form name="chngpwd" method="post" onSubmit="return valid();">
					...
					<p style="width: 350px;">
						...
						<b>PIN</b> <input type="text" name="pin" class="form-control" id="pin" placeholder="Enter PIN" required="">
					</p>
					...
					<a href="forgot-password.php" class="btn btn-success">Forgot Password</a>
				</form>
